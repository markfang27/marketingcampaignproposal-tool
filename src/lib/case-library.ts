...
export const CASE_LIBRARY: CaseEntry[] = [
  {
    ...
    brief: {
      ...
      budget: "约 200 万元",
      competitors: "元气森林、农夫山泉汽茶、可口可乐 AHHA",
      totalBudget: "200 万元",
      language: "zh",
    research: "web",
      duration: "8 周",
  ...
  },
  {
    ...
    brief: {
      ...
      budget: "约 150 万元",
      competitors: "韶音 OpenFit、Oladance、小米开放式耳机",
      totalBudget: "150 万元",
      language: "zh",
    research: "web",
      duration: "6 周",
  ...
  },
  {
    ...
    brief: {
      ...
      budget: "约 600 万元",
      competitors: "比亚迪元 PLUS、广汽埃安 Y、深蓝 S7",
      totalBudget: "600 万元",
      language: "zh",
    research: "web",
      duration: "12 周",
